...
function startvscode { code . }
function dotxdot { cd .. }
function dotxdot2 { cd ../.. }
function dotxdot3 { cd ../../.. }
function dserv { python manage.py runserver }
...
Set-Alias co 'startvscode'
Set-Alias cod 'code .'
Set-Alias dev 'Set-Location c:\dev'
Set-Alias proj 'Set-Location c:\dev\project'
Set-Alias cdp 'Set-Location c:\dev\project'
Set-Alias rai 'Set-Location c:\dev\project\_rails'
Set-Alias dja 'Set-Location c:\dev\project\_django'
Set-Alias usr 'Set-Location C:\Users\Owner'
Set-Alias '..' dotxdot
Set-Alias '../..' dotxdot2
Set-Alias '../../..' dotxdot3
...
#Set-Alias sozoo Invoke-Expression "C:\Users\B1NDL\OneDrive\Documents\PowerShell\Microsoft.PowerShell_profile.ps1"
#Set-Alias soz ". $PROFILE"
Set-Alias nifapi 'New-Item app.py, database.py, models.py, base.html'
Set-Alias touchfapi 'touch "{app,database,models}.py"; touch "base.html"'
...
function x {
    ...
    # Build the command by joining the arguments
    $command = $args -join ' '
    ...
    if ($LASTEXITCODE -eq 0 -and (Test-Path -Path $lastWord -PathType Container)) {
        # Change directory to the last word
        Set-Location -Path $lastWord
    }
}